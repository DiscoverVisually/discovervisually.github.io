(() => {
  ...
  const spreads = [
    {
      src: "../assets/lincoln-interior-first-day.webp",
      alt: "January 1, 1863: a young White House messenger begins work as Lincoln signs the Emancipation Proclamation",
      description:
        "Begin beside Lincoln’s desk on the day the Emancipation Proclamation changes the meaning of the war.",
    },
    {
      src: "../assets/lincoln-interior-fort-sumter.webp",
      alt: "Fort Sumter — the first shots of the Civil War across Charleston Harbor",
      description:
        "See the argument over the Union become cannon fire at Fort Sumter—and a nation go to war with itself.",
    },
    {
      src: "../assets/lincoln-interior-weapons.webp",
      alt: "The Weapon That Changed the Range — a visual guide to Civil War rifles, artillery and ammunition",
      description:
        "Look inside the rifle-musket and discover why old-looking weapons had become far more dangerous.",
    },
    {
      src: "../assets/lincoln-interior-gettysburg.webp",
      alt: "Why Gettysburg? — maps show how roads and army movements brought two forces together",
      description:
        "Trace the roads, supply lines and choices that made an unplanned crossroads the center of a decisive battle.",
    },
    {
      src: "../assets/lincoln-interior-272-words.webp",
      alt: "272 Words — the Gettysburg Address explains what the battle and the war were for",
      description:
        "Follow Lincoln through a two-minute address whose 272 words gave victory a larger meaning.",
    },
    {
      src: "../assets/lincoln-interior-richmond.webp",
      alt: "Freedom Reaches Richmond — Lincoln enters the fallen Confederate capital in April 1865",
      description:
        "See words written on paper become real street by street as freedom reaches the Confederate capital.",
    },
  ];
